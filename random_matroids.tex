...
The first concept we will need to establish is the \textit{independent sets} of a matroid, which is arguably the most common way to define a matroid. An independence system is a pair $(E, \mathcal{I})$, where $E$ is the ground set of elements, $E \not= \emptyset$, and $\mathcal{I}$ is the set of independent sets, $\mathcal{I} \subseteq 2^E$. The \textit{dependent sets} of a matroid are $2^E \setminus \mathcal{I}$. A matroid is an independence system with the following properties:
