...
\include{src/matroids.jl/mms_i.jl}
...
The Matroids.jl implementation of \pr{Matroid-Partition} is called\linebreak\jlinl{matroid_partition_knuth73} and is given Figure~\ref{code:matroid_partition_knuth73}. TODO: beskriv denne
\skelpar
