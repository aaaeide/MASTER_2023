...
We have already seen how to characterize a matroid using its rank function or its independent sets, but the other properties of a matroid have their own axiom systems that can equivalently be used to characterize a matroid.
