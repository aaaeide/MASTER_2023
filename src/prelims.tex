...
\begin{figure}\centering
  \resizebox{\columnwidth}{!}{
         \begin{tikzpicture}[> = stealth,  shorten > = 1pt,   auto,   node distance = 1.5cm, every node/.style={outer sep=0}]
  
  %%% LEVEL 1
  \node[draw, rounded corners]  (x) {1111};
  %%% LEVEL 2
  \node[draw, rounded corners]  [below left of=x] (B) {1101};
  \node[draw, rounded corners, fill=darktan] [below right of=x]  (C) {1011};
  \node[draw, rounded corners]  [left  of=B] (A) {1110};
  \node[draw, rounded corners] [right of=C]  (D) {0111};
  %%%% LEVEL 3
  \node[draw, rounded corners] [below of=B]  (AD) {0110};
  \node[draw, rounded corners, fill=darktan] [below of=C]  (BC) {1001};
  \node[draw, rounded corners] [below of=D]  (BD) {0101};
  \node[draw, rounded corners, fill=darktan] [below of=A]  (AC) {1010};
  \node[draw, rounded corners] [left  of=AC] (AB) {1100};
  \node[draw, rounded corners, fill=darktan] [right of=BD] (CD) {0011};
  
  %%  LEVEL   4
  \node[draw, rounded corners] [below of=AD]  (ABD) {0100};
  \node[draw, rounded corners, fill=darktan] [below of=BC]  (ACD) {0010};
  \node[draw, rounded corners, fill=darktan] [left of=ABD]  (ABC) {1000};
  \node[draw, rounded corners, fill=darktan] [right of=ACD] (BCD) {0001};
  
  %%%% LEVEL 5
  \node[draw, rounded corners, fill=darktan] [below right of=ABD]  (ABCD) {0000};
