...
\begin{figure}\centering
  ...
  %%% LEVEL 3 TO 4
      ...
      \path (AB)  edge [preaction={draw=darktan, line width=2mm}] node {} (ABC);
      \path (AB)  edge [preaction={draw=darktan, line width=2mm}] node {} (ABD);
      \path (AC)  edge [preaction={draw=darktan, line width=2mm}] node {} (ABC);
      \path (AC)  edge [preaction={draw=darktan, line width=2mm}] node {} (ACD);
      \path (AD)  edge [preaction={draw=darktan, line width=2mm}] node {} (ABD);
      \path (AD)  edge [preaction={draw=darktan, line width=2mm}] node {} (ACD);
      \path (BC)  edge [preaction={draw=darktan, line width=2mm}] node {} (ABC);
      \path (BC)  edge [preaction={draw=darktan, line width=2mm}] node {} (BCD);
      \path (BD)  edge [preaction={draw=darktan, line width=2mm}] node {} (ABD);
      \path (BD)  edge [preaction={draw=darktan, line width=2mm}] node {} (BCD);
...
\begin{figure}\centering
  ...
  %% LEVEL 2 to LEVEL 3
      \path (A)  edge [preaction={draw=darktan, line width=2mm}] node {} (AB);
      \path (A)  edge [preaction={draw=darktan, line width=2mm}] node {} (AC);
      \path (A)  edge [preaction={draw=darktan, line width=2mm}] node {} (AD);
      \path (B)  edge [preaction={draw=darktan, line width=2mm}] node {} (AB);
      \path (B)  edge [preaction={draw=darktan, line width=2mm}] node {} (BC);
      \path (B)  edge [preaction={draw=darktan, line width=2mm}] node {} (BD);
