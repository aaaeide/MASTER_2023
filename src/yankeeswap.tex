...
%   \begin{tabular}{ccccc}
%     \toprule
%     Instance & Time (Gen.) & Bytes (Gen.) & Time (Alloc.) & Bytes (Alloc.) \\
%     \midrule
%     8 $\times$ \texttt{GraphicMatroid(random\_er\_graph(64))} & 184.4\unit{\us} & 173.177 KiB & 22.4ms &  20.949 MiB \\
%     8 $\times$ \texttt{GraphicMatroid(random\_er\_graph(64))} & 172.6\unit{\us} & 97.184 KiB & 69.0ms &  36.820 MiB \\
%     8 $\times$ \texttt{GraphicMatroid(random\_ba\_graph(64))} & 155.8\unit{\us} & 100.402 KiB & 93.0ms &  44.633 MiB \\
%     8 $\times$ \texttt{random\_knuth\_matroid(13, [0,6,0])} & 34.1\unit{\ms} & 726.149 KiB & 429.1\unit{\us} &  234.673 KiB \\
%     8 $\times$ \texttt{random\_knuth\_matroid(16, [0,7,2])} & 434.1\unit{\ms} & 2.531 MiB & 1.3\unit{\ms} &  414.705 KiB \\
%     8 $\times$ \texttt{random\_knuth\_matroid(19, [0,8,3,1])} & 5.6\unit{\s} & 9.970 MiB & 3.6\unit{\ms} &  669.711 KiB \\
%     \bottomrule
%   \end{tabular}
%   \caption{Experimental results for some randomly generated fair allocation instances.}
%   \label{tab:results}
%   \end{table}
...
%       \toprule
%       $\alpha$-EF1 & $\alpha$-EFX$_+$ & $\alpha$-EFX$_0$ & $\alpha$-PROP & $\alpha$-PROPX$_+$ & $\alpha$-PROPX$_0$ & $\alpha$-MMS \\
%       \midrule
%       1.133 & 1.133 & 1.124 & 1.0 & 1.142 & 1.0 & 0.991 \\
%       1.095 & 1.095 & 1.053 & 1.225 & 1.487 & 1.225 & 0.958 \\
%       1.114 & 1.114 & 1.097 & 1.25 & 1.52 & 1.25 & 0.975
%     \end{tabular}
%     \caption*{Table~\ref{tab:results} cont.}
%   \end{table}
% \end{landscape}